function model=modelTrain(segment,ADR,do_feat_ext,FrameLen,FrameInc)
%do_feat_ext:if extract trainMODGDF
if (do_feat_ext)
    %% Read Data
...
%     MSPC_true = MSPC(1:T_NUM,:);
    ...
    save('D:\liblinear-2.1\matlab\MODGDF\trainData.mat','MSPC');
    save('D:\liblinear-2.1\matlab\MODGDF\trainLabel.mat','label');
end
load 'D:\liblinear-2.1\matlab\MODGDF\trainData.mat';
load 'D:\liblinear-2.1\matlab\MODGDF\trainLabel.mat';
%% Model Training
...
save('D:\liblinear-2.1\matlab\MODGDF\MODGDFmodel.mat','model');

...
%load 'D:\liblinear-2.1\matlab\Mixtured_feature\Mixtured_model.mat';
...
if (do_feat_ext)
    ...
    save('D:\liblinear-2.1\matlab\Mixtured_feature\testData.mat','MSPC');
    save('D:\liblinear-2.1\matlab\Mixtured_feature\testLabel.mat','label');
end

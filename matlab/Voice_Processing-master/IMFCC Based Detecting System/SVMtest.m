...
segment = 60;
do_feat_ext=false;%if extract IMFCC
model=modelTrain(segment,ADR,do_feat_ext);
%load 'D:\liblinear-2.1\matlab\IMFCC\IMFCC_SVMmodel.mat';
...
if (do_feat_ext)
    ...
    save('D:\liblinear-2.1\matlab\IMFCC\testData.mat','MSPC');
    save('D:\liblinear-2.1\matlab\IMFCC\testLabel.mat','label');
end;
load 'D:\liblinear-2.1\matlab\IMFCC\testData.mat';
load 'D:\liblinear-2.1\matlab\IMFCC\testLabel.mat';
%% predict

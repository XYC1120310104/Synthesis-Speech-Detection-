...
if (do_feat_ext)
    ...
    save('D:\liblinear-2.1\matlab\MFCC\trainData.mat','MSPC');
    save('D:\liblinear-2.1\matlab\MFCC\trainLabel.mat','label');
end
load 'D:\liblinear-2.1\matlab\MFCC\trainData.mat';
load 'D:\liblinear-2.1\matlab\MFCC\trainLabel.mat';
%% Model Training
...
save('D:\liblinear-2.1\matlab\MFCC\MFCCmodel.mat','model');
